                ...
                <div className="flex justify-between">
                    <div className="">
                        <a href="/" className="flex items-center  max-w-[50px]">
                            <img src={logo} className="h-full w-full mr-3" alt="Flowbite Logo" />
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Let go 5</span>
                        </a>
                    ...
                    <div className="grid grid-cols-1 gap-8  lg:grid-cols-2 ">
                        <div>
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                <li>
                                Địa chỉ: <a href="#" className="text-gray-700 transition hover:opacity-75"> 
                                    Phố Trịnh Văn Bô, Quận Nam Từ Liêm, Hà Nội
                                    </a>
                                </li>
